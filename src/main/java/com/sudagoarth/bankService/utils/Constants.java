...
public class Constants {
    ...
    public static final Passport esamPassport = Passport.builder()
            .series("CD")
            .identicalNumber("654321")
            .name("Esam")
            .surname("Suda")
            .address("Minsk, Belarus")
            .birthDate(LocalDate.of(1990, Month.JANUARY, 1))
    ...
    public static final Passport wantedPassport = Passport.builder()
            .series("EF")
            .identicalNumber("111111")
            .name("Wanted")
            .surname("Person")
            .address("Minsk, Belarus")
            .birthDate(LocalDate.of(1990, Month.JANUARY, 1))
    ...
    public static final Client wanted = Client.builder()
            .id("3")
            .name("Wanted")
            .surname("Person")
            .address("Minsk, Belarus")
            .phone("+375291234567")
            .birthday(LocalDate.of(1990, Month.JANUARY, 1))
            .wallet(Wallet.builder().moneyCount(BigDecimal.valueOf(100.20)).build())
            .passport(wantedPassport)
            .build();
    ...
    public static final Deposit earlySpring = Deposit.builder()
            ...
            .openDate(LocalDate.of(2023, Month.JANUARY, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .closeDate(LocalDate.of(2024, Month.JANUARY, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .percentage(5.0)
            .isCapitalized(true)
            .currency("USD")
            .termInMonth(12)
    ...
    public static final Deposit hotSummer = Deposit.builder()
            ...
            .openDate(LocalDate.of(2023, Month.JUNE, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .closeDate(LocalDate.of(2024, Month.JUNE, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .percentage(3.5)
            .isCapitalized(true)
            .currency("USD")
            .termInMonth(6)
    ...
    public static final Deposit colorfulAutumn = Deposit.builder()
            ...
            .openDate(LocalDate.of(2023, Month.SEPTEMBER, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .closeDate(LocalDate.of(2024, Month.SEPTEMBER, 1).atStartOfDay().atOffset(ZoneOffset.UTC))
            .percentage(4.0)
            .isCapitalized(false)
            .currency("USD")
            .termInMonth(12)
